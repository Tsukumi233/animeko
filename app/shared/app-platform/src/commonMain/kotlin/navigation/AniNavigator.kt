...
interface AniNavigator {
    ...
    fun navigateResourceLibrary(subjectId: Int, episodeId: Int? = null, initialFiles: List<String> = emptyList()) {
        navigate(NavRoutes.ResourceLibrary(subjectId, episodeId, initialFiles))
    }
